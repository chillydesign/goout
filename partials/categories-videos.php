<?php
 $categories = get_categories( array("hide_empty" => 0,   'taxonomy' => 'coolthing_cat') );
...
<li <?php echo $blog_active; ?>><a href="<?php echo get_post_type_archive_link( 'coolthing' ); ?>">Tous</a></li>
