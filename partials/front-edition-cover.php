...
$ff = 0;
$currently_class = 'currently_dark';
if ($latest_editions->have_posts() ):  while($latest_editions->have_posts()) : $latest_editions->the_post();
    ...
    if ($ff == 0 &&  $brightness > 50 ) $currently_class = 'currently_light';
    ...
    $str .=  '<a href="#header" class="down_arrow branding"></a>';
...
<?php  if ( sizeof($edition_strings) > 0) :  ?>
    ...
    <div id="latest_editions_cover" class="<?php echo $currently_class; ?>">
        ...
        <a href="#header" id="down_arrow" class="down_arrow"></a>
    </div>
<?php endif;  ?>
