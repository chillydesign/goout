<?php
 $categories = get_categories( array("hide_empty" => 0,   'taxonomy' => 'hotspot_cat') );
...
<li <?php echo $blog_active; ?>><a href="<?php echo get_post_type_archive_link( 'hotspot' ); ?>">Tous</a></li>
...
<li>
    <form action="">
        ...
        <input  type="hidden" name="post_type" value="hotspot">
    </form>
</li>
</ul>
